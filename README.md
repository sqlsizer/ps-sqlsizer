...
There is only limited support for **Azure Synapse Analytics SQL Pool** (work in progress). The long-term goal of the project is to create a generic tool for managing data in Microsoft cloud and on-premises data platforms.
