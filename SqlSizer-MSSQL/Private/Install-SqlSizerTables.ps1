function Install-SqlSizerTables
{
    ...
    $tmp = "CREATE TABLE SqlSizer.Operations(Id int primary key identity(1,1), [Table] smallint, [Color] int, [ToProcess] int NOT NULL, [Processed] bit NOT NULL, [Source] int, [Depth] int, [Created] datetime NOT NULL, [ProcessedDate] datetime NULL)"
    $null = Invoke-SqlcmdEx -Sql $tmp -Database $Database -ConnectionInfo $ConnectionInfo
    ...
    {
        $sql = "CREATE TABLE SqlSizerHistory.Subset ([Id] int primary key identity(1,1), [Guid] [uniqueidentifier] NOT NULL, [Name] varchar(256), [Created] datetime default(GETDATE()))"
        $null = Invoke-SqlcmdEx -Sql $sql -Database $Database -ConnectionInfo $ConnectionInfo
    }
    ...
    {
        $sql = "CREATE TABLE SqlSizerHistory.SubsetTable ([Id] int primary key identity(1,1), [SchemaName] varchar(256), [TableName] varchar(256), [PrimaryKeySize] int NOT NULL, [RowCount] int NOT NULL,  [SubsetId] int NOT NULL)"
        $null = Invoke-SqlcmdEx -Sql $sql -Database $Database -ConnectionInfo $ConnectionInfo
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBLu++QSi+Qekn4
# EMQsZqVJcrGlMLKCEcJnISMD1uu2GaCCIL4wggXJMIIEsaADAgECAhAbtY8lKt8j
...
# BDEiBCB5hKyqcKP/VxtBdKZtfOTpReNCAb7hlp8RoTjh3c1uXjANBgkqhkiG9w0B
# AQEFAASCAgA/uBgIE2SigIkPdLav3WTwnglZjbDYBzOl+A3AeifzCA1LfQFSrrEN
# Dqvk2JStyzE8oexEdxuLU44zPTdXfART1pMz9+Fc1YY40PBbgn71wYGqcv3MUU2I
# S1jBTXPsaYmTC/cgzXTJDEroXlcClUzsBUKcZnYnXjTJmOwU4DiTBfxeATmWGIeC
# MIRmCxxdjDJfijyxlbjV6tgJhwssYdie1dIElJrnJk0UAwj1IRzV7O4MNXflMMBT
# w03uKkUFTIfYzBWyncmyBh0Au9ThOOuRU9vciw+xqQGwmKhMjfQEbAM7IjtHAGh/
# XvsddxWpA0yLxg34YdCfjeJ962t4TLcgfK7nTTOx00qa8pt81cQuPFJiBUI7aZb8
# 1g7AebQhp/nvXZEPtVCBSqKGo96J+l1Cd+kU5vqys0HmhAFohSjXZcA+e0R5xHrq
# 6xsnADy1avpgct013jr3tCvUggwNPLcXr7VOX/W/MXlN2Eq0wHEBGXGP5WRd0BBZ
# N4oSzR8TyDyVh72AQCyjl6gDzHCtNSV5hHBpH1oCxLCuGU2fAeCOakj3MiWlpj2r
# MWPdZ4KUxIYtaXRqfCBP4JhFqYKgtjaQycAC7AnTBt9eeNx4J/VTHxxsP94G24GX
# P9F62+kehcqhihjN3SRTuII/1eEM7HwOW916H7eucASYRT7W3ZWW8KGCBAIwggP+
...
# Fw0yMjA5MjUxNjA3NDVaMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEIAO5mmRJdJhK
# lbbMXYDTRNB0+972yiQEhCvmzw5EIgeKMD8GCSqGSIb3DQEJBDEyBDC6RNk6Sjkh
# pjZdUsQQkbtWcp4Dp3JoHQ821O4UPJsML3g2kHnyxaFiSegEJBxo7W0wgZ8GCyqG
...
# 0GNbKumEyNZ0qjAwDQYJKoZIhvcNAQEBBQAEggIAvJcQ1oGnPLCkUAy8Jw3bWuvq
# hRVxC/UqK357lS2WUexN27kW9VHVlEKEKDtPMshOVJ6e5J+G2RrvY5T4ang3kF02
# pDx0RCWG7BWrum1HRq+JT25ASQENG157XNJcsB+kw+aTsZzM1RZuztO6bBYlu26i
# FuaOP81wgrnJ7llyqxvfPRAfeYfNDBP/VXWUNK8aXhAnivLiTWyeClr+VePXP3U0
# 7mHSIPqCHygrHiuvCPYQHvczWXMehTOwZEabY2eOtAKk36LixvVdLEreCNn2RAGx
# wVHp2kh+YOddEBFmqNbyMSCgjV9zfitlV4UAw5HgRmiJspjfUxdy0PSKTk7xeqWH
# +Ky+JQbWCcWiQ5mSQm+ch15zOg1ReteybPfPaqLOW1AB4DH+iuxA9I6AyKTrQhoT
# S8aIiUTBgMSni1sKkycJ3ezgI5ZkC/OhoHJIctt4C8a6tqNdGRTtfvd3/3VDYWwz
# thu3MkuxTRVURU1g9QAN4K6BOMTPYIR3D7q2ObBw3Qsf37wMuLjJsisfc4nETi+T
# 7QrUcRLRDjd/9dd25zoBigK4TC1LB6oOukSPX0aSZW+9c5dqODd+bQJWCGau+gb4
# /Vatw+8i28WmxEtRJuOOOR5TRLRsFJ8N/17UzFn285R+n5GuBkdz73uqKdPuk8YP
# +rGLGFUPUY4OlTTeWO8=
